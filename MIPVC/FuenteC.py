...
#Titulo				:FuenteV.py
#Descripción		:Interfaz de control de fuentes en modo Corriente.
...
def main():
	...
	##Fuente 1
	Cout1 = Button(win, Point(refx+23,refy-4), width_b2, heigh_b2, "☑")
	stop1 = Button(win, Point(refx+23,refy-8), width_b2, heigh_b2, "■")

	##Fuente 2
	Cout2 = Button(win, Point(refx+63,refy-4), width_b2, heigh_b2, "☑")
	...
	volt=Text(Point(refx,refy-8),"Tensión Limite(V): ")
	volt.setFace('arial')
	volt.setStyle('bold')
	volt.setSize(10)
	...
	volt_val=Entry(Point(refx+10,refy-8),10)
	...
	curr=Text(Point(refx,refy-4),"Corriente(A): ")
	curr.setFace('arial')
	curr.setStyle('bold')
	curr.setSize(10)
	...
	curr_val=Entry(Point(refx+10,refy-4),10)
	...
	volt2=Text(Point(refx+40,refy-8),"Tensión Limite(V): ")
	volt2.setFace('arial')
	volt2.setStyle('bold')
	volt2.setSize(10)
	...
	volt2_val=Entry(Point(refx+50,refy-8),10)
	...
	curr2=Text(Point(refx+40,refy-4),"Corriente(A): ")
	curr2.setFace('arial')
	curr2.setStyle('bold')
	curr2.setSize(10)
	...
	curr2_val=Entry(Point(refx+50,refy-4),10)
	...
	while not quitButton.clicked(pt):
		...
		if connects2.clicked(pt):
			...
			Cout2.activate()
			stop2.activate()
			Cout2.rect.setFill("#33CC00")
			stop2.rect.setFill("#C01A19")
			
		if Cout1.clicked(pt):
			V=float(volt_val.getText())
			C=float(curr_val.getText())
			kepco1.WriteCurr(V,C)
		
		if Cout2.clicked(pt):
			V2=float(volt_val.getText())
			C2=float(curr_val.getText())
			kepco1.WriteCurr(V2,C2)
